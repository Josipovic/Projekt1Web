...
{
    //[Authorize(Users ="katarina.josipovic@gmail.com")]
    public class ProductsController : Controller
    {
        private KataWebContext db = new KataWebContext();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,ShortDesc,Price,Discount,DiscountPrice,ImageUrl,Warranty,Available,New,Model,Colour,Delivery,CategoryId")] Product product)
        {
            if (ModelState.IsValid)
            {
